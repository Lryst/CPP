...
FragTrap::FragTrap() : ClapTrap()
{
	...
	this->_nrj = 100;
	this->_dam = 30;
	std::cout << YELLOW << "FragTrap Default constructor is called. Here we'r go" << RESET << std::endl;
}
...
FragTrap::FragTrap(std::string name) : ClapTrap(name)
{
	...
	this->_nrj = 100;
	this->_dam = 30;
	std::cout << YELLOW << "FragTrap Constructor is called. " << name << " is going to smash everything !" << RESET << std::endl;
}
